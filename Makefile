...
OBJ_DIR = OBJ
SRCS  = main.cpp timer.cpp input.cpp groFile.cpp itpFile.cpp charges.cpp traj.cpp calcFreq.cpp compare.cpp compareEnergy.cpp compareDipole.cpp compareHam.cpp
